...
`kafka-2.0.0-connector-kinetica-7.0.0.0-SNAPSHOT-jar-with-dependencies.jar`. 
...
```sh
java -cp kafka-2.0.0-connector-kinetica-7.0.0.0-tests.jar:kafka-2.0.0-connector-kinetica-7.0.0.0-SNAPHSOT-jar-with-dependencies.jar \
...
```sh
$ java -cp kafka-2.0.0-connector-kinetica-7.0.0.0-SNAPHSOT-jar-with-dependencies.jar \
